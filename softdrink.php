...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">SOFTDRINK</a>
            ...
            <a href="munchbag-in.html" class="btn btn-primary rounded-pill px-3 d-none d-lg-block">Log out<i
    ...
    <main>
        <h2 class="m-0 text-primary">SOFT Drinks</h2>
        <div class="container">
            <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                    <div class="product">
                        <form action="softdrink.php?action=add&id=<?php echo $row["pid"] ?>" method="post">
                            <div class="product">
